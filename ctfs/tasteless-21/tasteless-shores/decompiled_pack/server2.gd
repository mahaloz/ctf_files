...
const MsgServerUpdatePlayer = 255
const MsgServerUpdatePlayers = 254
const MsgServerJoin = 17
const MsgServerLeave = 153
const MsgServerAttack = 75
const MsgServerLoggedIn = 102
const MsgServerFrame = 204
const MsgServerDie = 1
const MsgServerEquip = 2
const MsgServerDamage = 51
const MsgServerItem = 116
const MsgServerFish = 176
const MsgServerSolo = 11
const MsgServerTryFlag = 103
const MsgServerFlag = 104
const MsgServerChat = 81
const MsgServerBld = 97
const MsgServerBlds = 98
const MsgServerSpawn = 111
const MsgServerTarget = 110
const MsgServerSpawnChest = 144
const MsgServerMark = 152
const MsgServerConch = 145
const MsgServerInteract = 32
const MsgServerAccount = 3
const MsgServerTogglePVP = 85
const MsgServerChangeArea = 86
...
func try_flag(node, flag):
	if not (flag in node.marker):
		prints(node, node.marker)
		return 
		
	if flag != "FLAG_CONCH" and node.global_transform.origin.distance_to(flags[flag].global_transform.origin) > 3:
