...
func _ready():
	...
	if not ("local" in OS.get_cmdline_args()):
...
onready  var username = $Username / UsernameInputas LineEdit
onready  var password = $Password / PasswordInputas LineEdit
onready  var error = $Erroras Label
