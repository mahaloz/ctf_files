...
func _process(_delta):
	...
	if parent.global_transform.origin.distance_to(Client.player.global_transform.origin) > 30.0 or OS.get_ticks_msec() > last_update + 5000:
		parent.hide()
